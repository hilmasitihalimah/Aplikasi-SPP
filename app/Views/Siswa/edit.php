...
<form method="POST" action='/siswa/update'>
    ...
    <div class="form-group">
        ...
        <input type="text" value="<?= $detailSiswa[0]['password']; ?>" name="txtInputPassword" class="form-control" placholder="Masukan Password Baru Siswa" autocomplete="off" required />
    </div>
