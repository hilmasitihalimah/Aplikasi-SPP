...
<div class="form-group">
    ...
    <select name="selectLevel" class="form-control">
        <option <?=$detailPetugas[0]['level']=='admin' ? 'selected':null;?> value="admin">Admin</option>
        <option <?=$detailPetugas[0]['level']=='petugas' ? 'selected':null;?> value="petugas">Petugas</option>
    </select>
</div>
