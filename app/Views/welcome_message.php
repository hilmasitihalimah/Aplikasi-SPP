  ...
  background-size: cover;">
				...
				<div class="menu">
					<ul>
						...
						<li class="menu-item hidden"><a href="/loginsiswa">LOGIN</a></li>
						</li>
					</ul>
				</div>
				...
				<div class="heroe">
					...
					<h2>This is SMKN 2 Kuningan Web application</h2>
					<i>UKK Rekayasa Perangkat Lunak</i>
					<p><i>hilma siti halimah</i></p>
