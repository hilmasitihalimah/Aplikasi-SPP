...
<div class="form-group">
    ...
    <input type="text" name="txtInputKompetensi" class="form-control" placeholder="Masukan nama kompetensi keahlian" value="<?=$detailKelas[0]['kompetensi_keahlian'];?>" autocomplete="off" required>
</div>
